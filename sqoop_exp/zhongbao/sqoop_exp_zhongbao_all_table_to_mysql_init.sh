...
two_two_start_date=`date  -d -2day "+%Y-%m-%d"`
...
sqoop export --connect ${mysql_url} --table ${sqoop_table} --export-dir ${export_dir}/day=${two_start_date}  --username ${mysql_user} -password ${mysql_password} -m 1 --fields-terminated-by '\001' --input-null-string '\\N' --input-null-non-string '\\N' --columns "create_date,province,city,total_send_merchant_ids"
echo $?
...
sqoop export --connect ${mysql_url} --table ${sqoop_table} --export-dir ${export_dir}/day=${two_start_date}  --username ${mysql_user} -password ${mysql_password} -m 1 --fields-terminated-by '\001' --input-null-string '\\N' --input-null-non-string '\\N' --columns "create_date,province,city,total_recharge_merchant_ids"
echo $?
...
sqoop export --connect ${mysql_url} --table ${sqoop_table} --export-dir ${export_dir}/day=${two_start_date}  --username ${mysql_user} -password ${mysql_password} -m 1 --fields-terminated-by '\001' --input-null-string '\\N' --input-null-non-string '\\N' --columns "create_date,province,city,total_receiver_rider_ids"
echo $?
...
sqoop export --connect ${mysql_url} --table ${sqoop_table} --export-dir ${export_dir}/day=${two_start_date}  --username ${mysql_user} -password ${mysql_password} -m 1 --fields-terminated-by '\001' --input-null-string '\\N' --input-null-non-string '\\N' --columns "create_date,province,city,total_recharge_account,total_deposit_account,total_rider_fine_account,total_insurance_account,total_commission_account,total_gift_account,total_rider_withdraw_account,total_create_num,total_finish_num,income_total_amount,outcome_total_amount"        
echo $?                
...
sqoop export --connect ${mysql_url} --table ${sqoop_table} --export-dir ${export_dir}/day=${two_start_date}  --username ${mysql_user} -password ${mysql_password} -m 1 --fields-terminated-by '\001' --input-null-string '\\N' --input-null-non-string '\\N' --columns "create_date,province,city,district,longitude,latitude,finish_num,cancel_num"
echo $?
