...
insert overwrite table tubobo_reportdata.tubobo_express_increase_store_num_info partition (day='${start_date}')
select 
...
from ds_tubobo_express.bas_storeentity_pd a where a.day='${start_date}';"
