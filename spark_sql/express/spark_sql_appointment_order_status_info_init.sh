...
insert overwrite table tubobo_reportdata.express_appointment_order_status_info partition (day='${two_start_date}')
select 
...
from ds_tubobo_express.bas_appointtaskentity_pd where day='${two_start_date}' and taskType='DISTRIBUTION'
